# Journal Entry API 📔A full-stack personal journal application built with Spring Boot, MongoDB, JWT authentication, and React. The application provides authenticated users with private journal management and AI-powered analysis of journal entries.
